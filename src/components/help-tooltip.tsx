  ...
  return (
    <Popover className="relative inline-flex">
      ...
      <PopoverPanel
        transition
        anchor="right"
        className="ml-2 w-64 divide-y divide-white/5 rounded-xl bg-black/5 px-3 py-2 text-sm/4 transition duration-200 ease-in-out data-[closed]:-translate-y-1 data-[closed]:opacity-0 dark:bg-white/5"
      >
        {props.children}
      </PopoverPanel>
    </Popover>
